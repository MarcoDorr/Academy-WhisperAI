...
""" 
    Converts all German mp4-files of the folder 'videos' to SRT-files in the folder 'srt_files'. So German to German only.
...
def whisper_result_cached(path, language: str, do_translation=False):
    """bla"""
